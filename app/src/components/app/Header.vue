	...
	<div id="header" class="app-header">
		...
		<!-- <div class="brand">
			<RouterLink to="/" class="brand-logo">
				...
				<span class="brand-text">V2AIR</span>
			</RouterLink>
		</div> -->
		<div class="brand">
			<RouterLink to="/" class="brand-logo">
				<img src="/assets/logo/CMYK/PNG/02_V2AIR_ocean_white_CMYK.png" alt="V2AIR Logo" class="brand-img" />
			</RouterLink>
		</div>
		<!-- END brand -->
			...
			<div class="menu-item dropdown dropdown-mobile-full">
				...
				<div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
					...
					<RouterLink to="/email/inbox" class="dropdown-item d-flex align-items-center">INBOX <i
							class="bi bi-envelope ms-auto text-theme fs-16px my-n1"></i></RouterLink>
					<RouterLink to="/calendar" class="dropdown-item d-flex align-items-center">CALENDAR <i
							class="bi bi-calendar ms-auto text-theme fs-16px my-n1"></i></RouterLink>
					...
					<RouterLink to="/page/login" class="dropdown-item d-flex align-items-center">LOGOUT <i
							class="bi bi-toggle-off ms-auto text-theme fs-16px my-n1"></i></RouterLink>
				</div>
			</div>
		</div>
		<!-- END menu -->
