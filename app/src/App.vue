<template>
	<div class="app" v-bind:class="{
		...
		<div v-if="isLoading" class="loading-wrapper">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1236 923.1" class="logo">
				<g>
					<g>
...
onMounted(() => {
	setTimeout(() => {
		isLoading.value = false; // Hide loading after initial loading
	}, 3000); // Adjust the duration as needed
});

// Keep the router hooks to handle progress only, without changing loading state
